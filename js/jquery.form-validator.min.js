...
(function ($) {
    ...
    $.formUtils = {
        ...
        LANG: {
            ...
            badEmail: 'Ingresa un e-mail válido',
            badTelephone: 'Ingresa un telefono válido',
    ...
    $.formUtils.addValidator({
        name: 'telephone',
        validatorFunction: function (phone_number,element) {
            phone_number = phone_number.replace(/\s+/g, "");
            return phone_number.length == 10 && phone_number.match(/^\+[0-9]{10}$/);
